...
Singleton {
    ...
    property var models: Config.options.policies.ai === 2 ? {} : {
        ...
        "openrouter-kimi-k2-0905": aiModelComponent.createObject(this, {
            "name": "kimi-k2-0905",
            "icon": "kimi-k2-0905",
            "description": Translation.tr("Online via %1 | %2's model").arg("OpenRouter").arg("kimi-k2-0905"),
            "homepage": "https://openrouter.ai/moonshotai/kimi-k2-0905",
            "endpoint": "https://openrouter.ai/api/v1/chat/completions",
            "model": "moonshotai/kimi-k2-0905",
            "requires_key": true,
            "key_id": "openrouter",
            "key_get_link": "https://openrouter.ai/settings/keys",
            "key_get_description": Translation.tr("**Pricing**: No"),
        }),
    }
